"""Phase 7: objectives and plans - what the user asked Prometheus for, and its decomposition.
...
not a workaround; it is what a plan is. Prometheus decomposes an objective into tasks
