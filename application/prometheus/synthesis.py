...
The user asked Prometheus, not the team, and has not seen the plan. Handing back a list
    ...
    async def synthesize(
        ...
        *,
        ...
        if not answer:
            ...
            log.warning("prometheus.synthesis_empty", objective_id=str(objective.id))
            return results
        return answer
